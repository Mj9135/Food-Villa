...
function Cart() {
  ...
  return (
    <div className="sm:w-9/12 mx-auto mt-52 sm:my-4 flex flex-col md:flex-row flex-wrap justify-between items-center relative">
      <div className="m-4 sm:w-8/12">
        <div className="p-4 rounded-md my-4 shadow-lg bg-gradient-to-r from-gray-200 to-gray-400">
          <button
            className="p-2 rounded-md bg-gradient-to-r from-black to-gray-700 text-white font-bold shadow-lg"
      ...
      <div className="my-4 sm:w-3/12">
        <div className="bg-white w-48 h-56 rounded-lg border-2 border-gray-400 shadow-lg">
