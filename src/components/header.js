  ...
  return (
    <header className="sticky top-0 bg-white z-10 shadow-md">
      <div className="p-3 w-full m-0 md:m-auto md:w-4/5 flex justify-between items-center">
        <Link
          to="/"
          className=" w-[140px] h-[50px]   md:w-[240px] md:h-[100px] md:ml-[-110px] md:mt-2"
        >
          <img src={logo} alt="" />
        </Link>
        ...
        <ul className="fixed ml-[280px]    p-2 justify-around bg-white  w-full md:mr-[-102px] md:flex md:justify-between md:gap-5 md:text-xl md:static md:w-auto">
          <Link to="/">
            <li className="px-3 hidden md:block py-2">Home</li>
          </Link>

          <Link to="/about">
            <li className="px-3 hidden md:block py-2">About</li>
          </Link>

          <Link to="/contact">
            <li className="px-3 hidden md:block py-2">Contact</li>
          </Link>
